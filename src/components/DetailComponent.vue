<template>
    <div class="text-left justify-content-center row">
        <div class="col-4 mb-5" v-for="phone in info">
            <div class="card grow-shadow" style="width: 98%">
                <img v-if="phone.phonePhoto != null" style="height: 17rem; width: 100%" class="card-img-top" :src="phone.phonePhoto">
